  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1.6rem" }}>
        ...
        <div className="footer-text">087-7597863</div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1.6rem" }}>
        ...
        <div className="footer-text">ratiporn@gmail.com</div>
      </div>
      {/*github*/}
      <Link to="https://github.com/Lavalse41" target="_blank">
        <div style={{ display: "flex", alignItems: "center", gap: "1.6rem" }}>
          <div className="contact-logo-circle">
            {" "}
            <svg
          ...
          <div className="footer-text">github.com/Lavalse41</div>
        </div>
      </Link>
    </div>
  );
